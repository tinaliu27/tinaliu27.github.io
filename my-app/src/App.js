...
import UBCOUX from './design/UbcoUX'; 
import './app.css';
...
import ProjectUBC from './design/UbcoUX';
import ProjectTeamable from'./design/Teamable'; 
import ProjectFreshWaste from './design/Fresh2Waste';
...
function App() {
  // theme: 'light' => light background (#FFF8E7) with dark text (#291C15)
  // theme: 'dark' => dark background (#291C15) with light text (#FFF8E7)
  ...
  useEffect(() => {
    const lightBg = '#FFF8E7';
    const darkBg = '#291C15';
    const lightText = '#291C15';
    const darkText = '#FFF8E7';
    const root = document.documentElement;

    if (theme === 'light') {
      root.style.setProperty('--bg', lightBg);
      root.style.setProperty('--text', lightText);
      root.style.setProperty('--header-bg', lightBg);
      root.style.setProperty('--header-text', lightText);
      root.style.setProperty('--link-text', lightText);
    } else {
      root.style.setProperty('--bg', darkBg);
      root.style.setProperty('--text', darkText);
      root.style.setProperty('--header-bg', darkBg);
      root.style.setProperty('--header-text', darkText);
      root.style.setProperty('--link-text', darkText);
    }
